...
# My original way:
regexp_original = r"[a-z]+(?:-[a-z]+)?"

# My second way:
regexp = r"[a-z]+(?:-[a-z]+)?"

# Better way using the OR (|) operator
regexp_better = r"[a-z]+-[a-z]+|[a-z]+"

# Better again:
regexp_better_again = r"(?:[a-z]+-[a-z]+)|(?:[a-z]+)"


regexp_another = r"[a-z]+-[a-z]+|[a-z]+(?:-[a-z]+)?"

regexp_another_2 = r"[a-z]+(?:-[a-z]+)?|[a-z]+"
