...
<ul>
  ...
  <li> Text can be <b>bold</b>, <i>italic</i>, <small>small</small>, <big>big</big>, or look like a <tt>typewriter</tt>.</li> 
  <li> 
    There are also ordered lists that use (OL) tags. Let's make one nested inside our current list item 
    <ol>
      <li> Text can be <strong>strong</strong> or <em>emphasised</em>, which typically renders like bold or italics. </li>
      <li> Webpages can have <a href="target">hyperlinks</a> </li>
    </ol>
  </li>
  <li> It is also possible to include images <img src="cs262.png"></img> </li>
