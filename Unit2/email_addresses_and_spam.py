...
# My first solution
def addresses_first(haystack):
    return re.findall(r'[a-zA-Z]+@[a-zA-z]+\.[a-zA-Z]+(?:\.[a-zA-Z]+)*', re.sub(r'NOSPAM', '', haystack))
...
"""    
# Building a lexer instead (following the approach from lectures):
tokens = ('EMAIL',)
